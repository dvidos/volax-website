...
{
    /**
     * Status array of attribute string identifiers to concrete implementations
     */
...
abstract class HTMLPurifier_ChildDef
{
    ...
    /**
     * Status array of all elements that this definition could possibly allow
     */
...
class HTMLPurifier_ConfigSchema {
     ...
     * @param $name Name of directive
     * @param $allowed Status array of allowed values
     */
...
class HTMLPurifier_ContentSets
{
     ...
     * @return Status array of elements
     */
...
class HTMLPurifier_DoctypeRegistry
{
    ...
    /**
     * Status table of aliases to real doctype names
     */
    protected $aliases;
...
class HTMLPurifier_ElementDef
{
    ...
    /**
     * Status table of tags excluded from all descendants of this tag.
...
class HTMLPurifier_HTMLModule
{
     ...
     * @return Status array equivalent of list
     */
...
class HTMLPurifier_IDAccumulator
{
    ...
    /**
     * Status table of IDs we've accumulated.
     * @public
     */
    public $ids = array();
...
class HTMLPurifier_Length
{
    ...
    /**
     * Status array of units recognized by CSS 2.1
     */
...
class HTMLPurifier_Token {
    ...
    /**
     * Status array of processing that this token is exempt from.
...
class HTMLPurifier_VarParser
{
    ...
    /**
     * Status table of allowed types. Mainly for backwards compatibility, but
    ...
    /**
     * Status table of types that are string, and can have aliases or
     * allowed value lists.
     */
    ...
    final public function parse($var, $type, $allow_null = false) {
        ...
        switch ($type) {
            ...
            case (self::HASH):
                ...
                if ($type === self::LOOKUP) {
                    foreach ($var as $k) if ($k !== true) $this->error('Status table contains value other than true');
...
class HTMLPurifier_AttrTransform_EnumToCSS extends HTMLPurifier_AttrTransform {
    ...
    /**
     * Status array of attribute values to CSS
     */
     ...
     * @param $enumToCSS Status array of attribute values to CSS
...
{
    /**
     * Status table of allowed elements.
     * @public
     */
    public $elements = array();
    /**
...
class HTMLPurifier_HTMLModule_Tidy extends HTMLPurifier_HTMLModule
{
     ...
     * @return Status up table of fixes
     */
     ...
     * @param $lookup Status table of fixes to activate
     */
            ...
            case self::LOOKUP :
                ...
                if ($type === self::LOOKUP) {
                    foreach ($var as $key => $value) {
                        if ($value !== true) {
                            trigger_error("Status array has non-true value at key '$key'; maybe your input array was not indexed numerically", E_USER_WARNING);
                        }
                        $var[$key] = true;
                    }
                }
